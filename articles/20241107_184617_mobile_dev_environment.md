...
Nginxとか有名
443ポートから入ってきたリクエストをURLで振り分けることにより、複数サブドメインとポートを対応させることも可能
...
## まとめ（まだまとまっていないけど）
VSCode Serverを開発機で起動し、Nginx Proxy Manager等を利用しつつ
